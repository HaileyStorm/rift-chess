...
function $Shape$bounds$(_shape_0) {
  if (_shape_0.$ === "Empty") {
...
function $Shape$rounded_case$(_valid_0, _l_0, _t_0, _r_0, _b_0, _radius_0) {
  if (!_valid_0) {
    return {$: "Empty"};
  } else {
...
function $Shape$rounded$(_l_0, _t_0, _r_0, _b_0, _radius_0) {
  const _x_0 = Math.fround(_radius_0 * 2);
  const _x_1 = run_loop($F32$min$(Math.fround(_r_0 - _l_0), Math.fround(_b_0 - _t_0)));
  return run_jump($Shape$rounded_case$, [run_loop($Bool$and$(run_loop($Bool$and$(run_loop($Bool$and$(run_loop($Brush$finite$(_l_0)), run_loop($Brush$finite$(_t_0)))), run_loop($Bool$and$(run_loop($Brush$finite$(_r_0)), run_loop($Brush$finite$(_b_0)))))), run_loop($Bool$and$(run_loop($Bool$and$((_l_0 < _r_0), (_t_0 < _b_0))), run_loop($Bool$and$((_radius_0 >= 0), (_x_0 <= _x_1))))))), _l_0, _t_0, _r_0, _b_0, _radius_0]);
}

function $Shape$ellipse_case$(_valid_0, _cx_0, _cy_0, _rx_0, _ry_0) {
  if (!_valid_0) {
    return {$: "Empty"};
  } else {
...
function $Shape$ellipse$(_cx_0, _cy_0, _rx_0, _ry_0) {
  return run_jump($Shape$ellipse_case$, [run_loop($Bool$and$(run_loop($Bool$and$(run_loop($Brush$finite$(_cx_0)), run_loop($Brush$finite$(_cy_0)))), run_loop($Bool$and$(run_loop($Bool$and$((_rx_0 >= 0.00390625), (_rx_0 <= 4096))), run_loop($Bool$and$((_ry_0 >= 0.00390625), (_ry_0 <= 4096))))))), _cx_0, _cy_0, _rx_0, _ry_0]);
}

function $Shape$closed$(_edges_0, _rule_0) {
  return {$: "Closed", ["edges"]: _edges_0, ["rule"]: _rule_0, ["bounds"]: run_loop($PathFill$bounds$(_edges_0))};
}

function $Shape$stroked$(_path_0) {
  return {$: "Stroked", ["path"]: _path_0, ["bounds"]: run_loop($$$$Stroke$bounds$(_path_0))};
}

function $Shape$union$(_left_0, _right_0) {
  return {$: "Union", ["left"]: _left_0, ["right"]: _right_0, ["bounds"]: run_loop($$$$Rect$union$(run_loop($Shape$bounds$(_left_0)), run_loop($Shape$bounds$(_right_0))))};
}

function $Shape$intersect$(_left_0, _right_0) {
  return {$: "Intersection", ["left"]: _left_0, ["right"]: _right_0, ["bounds"]: run_loop($$$$Rect$intersect$(run_loop($Shape$bounds$(_left_0)), run_loop($Shape$bounds$(_right_0))))};
}

function $Shape$subtract$(_left_0, _right_0) {
  return {$: "Difference", ["left"]: _left_0, ["right"]: _right_0, ["bounds"]: run_loop($Shape$bounds$(_left_0))};
}

function $Shape$rounded_hit$(_l_0, _t_0, _r_0, _b_0, _radius_0, _x_0, _y_0) {
...
function $Shape$test$(_shape_0, _outside_0, _x_0, _y_0) {
  if (_shape_0.$ === "Empty") {
    if (_outside_0) {
      return false;
    } else {
    ...
    if (_outside_0) {
      ...
      return run_jump($Shape$rounded_hit$, [_l_0, _t_0, _r_0, _b_0, _radius_0, _x_0, _y_0]);
    }
  } else if (_shape_0.$ === "Ellipse") {
    const _cx_0 = _shape_0["cx"];
    const _cy_0 = _shape_0["cy"];
    ...
    if (_outside_0) {
      ...
      const _x_6 = run_loop($Shape$test$(_left_0, run_loop($Bool$not$(run_loop($$$$Rect$point$(run_loop($Shape$bounds$(_left_0)), (_x_0 >= 1 && _x_0 < 4294967296 ? Math.floor(_x_0) : 0), (_y_0 >= 1 && _y_0 < 4294967296 ? Math.floor(_y_0) : 0))))), _x_0, _y_0));
      const _x_7 = run_loop($Shape$test$(_right_0, run_loop($Bool$not$(run_loop($$$$Rect$point$(run_loop($Shape$bounds$(_right_0)), (_x_0 >= 1 && _x_0 < 4294967296 ? Math.floor(_x_0) : 0), (_y_0 >= 1 && _y_0 < 4294967296 ? Math.floor(_y_0) : 0))))), _x_0, _y_0));
      return (_x_6 || _x_7);
    }
  } else if (_shape_0.$ === "Intersection") {
    const _left_1 = _shape_0["left"];
    ...
    if (_outside_0) {
      ...
      return run_jump($Bool$and$, [run_loop($Shape$test$(_left_1, run_loop($Bool$not$(run_loop($$$$Rect$point$(run_loop($Shape$bounds$(_left_1)), (_x_0 >= 1 && _x_0 < 4294967296 ? Math.floor(_x_0) : 0), (_y_0 >= 1 && _y_0 < 4294967296 ? Math.floor(_y_0) : 0))))), _x_0, _y_0)), run_loop($Shape$test$(_right_1, run_loop($Bool$not$(run_loop($$$$Rect$point$(run_loop($Shape$bounds$(_right_1)), (_x_0 >= 1 && _x_0 < 4294967296 ? Math.floor(_x_0) : 0), (_y_0 >= 1 && _y_0 < 4294967296 ? Math.floor(_y_0) : 0))))), _x_0, _y_0))]);
    }
  } else {
    const _left_2 = _shape_0["left"];
    const _right_2 = _shape_0["right"];
    ...
    if (_outside_0) {
      ...
      return run_jump($Bool$and$, [run_loop($Shape$test$(_left_2, run_loop($Bool$not$(run_loop($$$$Rect$point$(run_loop($Shape$bounds$(_left_2)), (_x_0 >= 1 && _x_0 < 4294967296 ? Math.floor(_x_0) : 0), (_y_0 >= 1 && _y_0 < 4294967296 ? Math.floor(_y_0) : 0))))), _x_0, _y_0)), run_loop($Bool$not$(run_loop($Shape$test$(_right_2, run_loop($Bool$not$(run_loop($$$$Rect$point$(run_loop($Shape$bounds$(_right_2)), (_x_0 >= 1 && _x_0 < 4294967296 ? Math.floor(_x_0) : 0), (_y_0 >= 1 && _y_0 < 4294967296 ? Math.floor(_y_0) : 0))))), _x_0, _y_0))))]);
    }
  }
}

function $Shape$hit$(_shape_0, _x_0, _y_0) {
  return run_jump($Shape$test$, [_shape_0, run_loop($Bool$not$(run_loop($$$$Rect$point$(run_loop($Shape$bounds$(_shape_0)), (_x_0 >= 1 && _x_0 < 4294967296 ? Math.floor(_x_0) : 0), (_y_0 >= 1 && _y_0 < 4294967296 ? Math.floor(_y_0) : 0))))), _x_0, _y_0]);
}

function $Shape$grid$(_quality_0) {
...
function $Shape$samples$(_fuel_0, _shape_0, _x_0, _y_0, _grid_0, _index_0, _total_0) {
  if (_fuel_0 === 0n) {
    return _total_0;
  } else {
    const _rest_0 = (_fuel_0 - 1n);
    ...
    const _x_11 = run_loop($$$$Shapes$bit$(run_loop($Shape$hit$(_shape_0, _xx_0, _yy_0))));
    return run_jump($Shape$samples$, [_rest_0, _shape_0, _x_0, _y_0, _grid_0, ((_index_0 + 1) >>> 0), ((_total_0 + _x_11) >>> 0)]);
  }
}

function $Shape$coverage$(_shape_0, _quality_0, _x_0, _y_0) {
  const _n_0 = run_loop($Shape$grid$(_quality_0));
  const _count_0 = (Math.imul(_n_0, _n_0) >>> 0);
  const _x_1 = run_loop($Shape$samples$(BigInt(_count_0), _shape_0, Math.fround(_x_0), Math.fround(_y_0), _n_0, 0, 0));
...
function $Paint$pixel$(_zero_0, _coverage_0, _brush_0, _x_0, _y_0, _target_0) {
  if (_zero_0) {
    return _target_0;
  } else {
    if (_target_0.$ === "Pix") {
      ...
      return {$: "Pix", ["color"]: run_loop($Premul$blend$({$: "Over"}, run_loop($Premul$scale$(run_loop($Brush$sample$(_brush_0, Math.fround(_x_1 + 0.5), Math.fround(_x_2 + 0.5))), _coverage_0)), _background_0))};
    } else {
...
function $Paint$region$(_depth_0, _span_0, _x_0, _y_0, _outside_0, _shape_0, _brush_0, _quality_0, _clip_0, _target_0) {
  if (_depth_0 === 0n) {
    if (_outside_0) {
      return _target_0;
    } else {
      const _coverage_0 = run_loop($Shape$coverage$(_shape_0, _quality_0, _x_0, _y_0));
      return run_jump($Paint$pixel$, [(_coverage_0 === 0), _coverage_0, _brush_0, _x_0, _y_0, _target_0]);
    }
  } else {
    const _rest_0 = (_depth_0 - 1n);
    if (_outside_0) {
      ...
      const _a_0 = run_loop($Paint$region$(_rest_0, _h_0, _x_0, _y_0, run_loop($Bool$not$(run_loop($$$$Rect$overlaps$(_clip_0, run_loop($$$$Rect$cell$(_x_0, _y_0, _h_0)))))), _shape_0, _brush_0, _quality_0, _clip_0, run_loop($$$$ImageOps$tl$(_target_0))));
      const _b_0 = run_loop($Paint$region$(_rest_0, _h_0, _xx_0, _y_0, run_loop($Bool$not$(run_loop($$$$Rect$overlaps$(_clip_0, run_loop($$$$Rect$cell$(_xx_0, _y_0, _h_0)))))), _shape_0, _brush_0, _quality_0, _clip_0, run_loop($$$$ImageOps$tr$(_target_0))));
      const _c_0 = run_loop($Paint$region$(_rest_0, _h_0, _x_0, _yy_0, run_loop($Bool$not$(run_loop($$$$Rect$overlaps$(_clip_0, run_loop($$$$Rect$cell$(_x_0, _yy_0, _h_0)))))), _shape_0, _brush_0, _quality_0, _clip_0, run_loop($$$$ImageOps$bl$(_target_0))));
      const _d_0 = run_loop($Paint$region$(_rest_0, _h_0, _xx_0, _yy_0, run_loop($Bool$not$(run_loop($$$$Rect$overlaps$(_clip_0, run_loop($$$$Rect$cell$(_xx_0, _yy_0, _h_0)))))), _shape_0, _brush_0, _quality_0, _clip_0, run_loop($$$$ImageOps$br$(_target_0))));
      return run_jump($$$$ImageOps$quad$, [_a_0, _b_0, _c_0, _d_0]);
    }
  }
}

function $Paint$pool$(_forks_0, _depth_0, _span_0, _x_0, _y_0, _outside_0, _shape_0, _brush_0, _quality_0, _clip_0, _target_0) {
  if (_forks_0 === 0n) {
    if (_outside_0) {
      return _target_0;
    } else {
      return run_jump($Paint$region$, [_depth_0, _span_0, _x_0, _y_0, false, _shape_0, _brush_0, _quality_0, _clip_0, _target_0]);
    }
  } else {
    ...
    if (_depth_0 === 0n) {
      if (_outside_0) {
        ...
        return run_jump($Paint$region$, [0n, _span_0, _x_0, _y_0, false, _shape_0, _brush_0, _quality_0, _clip_0, _target_0]);
      }
    } else {
      ...
      if (_outside_0) {
        ...
        const _xx_0 = ((_x_0 + _h_0) >>> 0);
        const _yy_0 = ((_y_0 + _h_0) >>> 0);
        const _a_0 = run_loop($Paint$pool$(_rest_0, _lower_0, _h_0, _x_0, _y_0, run_loop($Bool$not$(run_loop($$$$Rect$overlaps$(_clip_0, run_loop($$$$Rect$cell$(_x_0, _y_0, _h_0)))))), _shape_0, _brush_0, _quality_0, _clip_0, run_loop($$$$ImageOps$tl$(_target_0))));
        const _b_0 = run_loop($Paint$pool$(_rest_0, _lower_0, _h_0, _xx_0, _y_0, run_loop($Bool$not$(run_loop($$$$Rect$overlaps$(_clip_0, run_loop($$$$Rect$cell$(_xx_0, _y_0, _h_0)))))), _shape_0, _brush_0, _quality_0, _clip_0, run_loop($$$$ImageOps$tr$(_target_0))));
        const _c_0 = run_loop($Paint$pool$(_rest_0, _lower_0, _h_0, _x_0, _yy_0, run_loop($Bool$not$(run_loop($$$$Rect$overlaps$(_clip_0, run_loop($$$$Rect$cell$(_x_0, _yy_0, _h_0)))))), _shape_0, _brush_0, _quality_0, _clip_0, run_loop($$$$ImageOps$bl$(_target_0))));
        const _d_0 = run_loop($Paint$pool$(_rest_0, _lower_0, _h_0, _xx_0, _yy_0, run_loop($Bool$not$(run_loop($$$$Rect$overlaps$(_clip_0, run_loop($$$$Rect$cell$(_xx_0, _yy_0, _h_0)))))), _shape_0, _brush_0, _quality_0, _clip_0, run_loop($$$$ImageOps$br$(_target_0))));
        return run_jump($$$$ImageOps$quad$, [_a_0, _b_0, _c_0, _d_0]);
      }
    }
  }
...
function $Paint$fill$(_surface_0, _shape_0, _brush_0, _quality_0, _forks_0, _clip_0) {
  const _depth_0 = _surface_0["depth"];
  const _size_0 = _surface_0["size"];
  const _pixels_0 = _surface_0["pixels"];
  const _bounds_0 = run_loop($$$$Rect$intersect$(_clip_0, run_loop($Shape$bounds$(_shape_0))));
  return {$: "Surface", ["depth"]: _depth_0, ["size"]: _size_0, ["pixels"]: run_loop($Paint$pool$(_forks_0, _depth_0, _size_0, 0, 0, run_loop($Bool$not$(run_loop($$$$Rect$overlaps$(_bounds_0, run_loop($$$$Rect$screen$(_size_0)))))), _shape_0, _brush_0, _quality_0, _bounds_0, _pixels_0))};
}

function $command$(_shape_0, _brush_0, _quality_0, _clip_0) {
  return {$: "Command", ["shape"]: _shape_0, ["brush"]: _brush_0, ["quality"]: _quality_0, ["bounds"]: run_loop($$$$Rect$intersect$(run_loop($Shape$bounds$(_shape_0)), _clip_0))};
}

function $bounds$(_command_0) {
...
function $keep$(_visible_0, _command_0, _tail_0) {
  if (!_visible_0) {
    return _tail_0;
  } else {
...
function $select$(_commands_0, _region_0) {
  if (_commands_0.$ === "Nil") {
    return {$: "Nil"};
  } else {
    const _head_0 = _commands_0["head"];
    const _tail_0 = _commands_0["tail"];
    return run_jump($keep$, [run_loop($$$$Rect$overlaps$(run_loop($bounds$(_head_0)), _region_0)), _head_0, run_loop($select$(_tail_0, _region_0))]);
  }
}

function $one$(_command_0, _depth_0, _span_0, _x_0, _y_0, _target_0) {
  const _shape_0 = _command_0["shape"];
  const _brush_0 = _command_0["brush"];
  const _quality_0 = _command_0["quality"];
  const _bounds_0 = _command_0["bounds"];
  return run_jump($Paint$region$, [_depth_0, _span_0, _x_0, _y_0, run_loop($Bool$not$(run_loop($$$$Rect$overlaps$(_bounds_0, run_loop($$$$Rect$cell$(_x_0, _y_0, _span_0)))))), _shape_0, _brush_0, _quality_0, _bounds_0, _target_0]);
}

function $serial$(_commands_0, _depth_0, _span_0, _x_0, _y_0, _target_0) {
  if (_commands_0.$ === "Nil") {
    return _target_0;
  } else {
    const _head_0 = _commands_0["head"];
    const _tail_0 = _commands_0["tail"];
    return run_jump($serial$, [_tail_0, _depth_0, _span_0, _x_0, _y_0, run_loop($one$(_head_0, _depth_0, _span_0, _x_0, _y_0, _target_0))]);
  }
}

function $pool$(_forks_0, _depth_0, _span_0, _x_0, _y_0, _commands_0, _target_0) {
  if (_forks_0 === 0n) {
    if (_commands_0.$ === "Nil") {
      return _target_0;
    } else {
      return run_jump($serial$, [_commands_0, _depth_0, _span_0, _x_0, _y_0, _target_0]);
    }
  } else {
    const _rest_0 = (_forks_0 - 1n);
    if (_depth_0 === 0n) {
      if (_commands_0.$ === "Nil") {
        ...
        return run_jump($serial$, [_commands_0, 0n, _span_0, _x_0, _y_0, _target_0]);
      }
    } else {
      const _lower_0 = (_depth_0 - 1n);
      if (_commands_0.$ === "Nil") {
        ...
        const _xx_0 = ((_x_0 + _h_0) >>> 0);
        const _yy_0 = ((_y_0 + _h_0) >>> 0);
        const _a_0 = run_loop($pool$(_rest_0, _lower_0, _h_0, _x_0, _y_0, run_loop($select$(_commands_0, run_loop($$$$Rect$cell$(_x_0, _y_0, _h_0)))), run_loop($$$$ImageOps$tl$(_target_0))));
        const _b_0 = run_loop($pool$(_rest_0, _lower_0, _h_0, _xx_0, _y_0, run_loop($select$(_commands_0, run_loop($$$$Rect$cell$(_xx_0, _y_0, _h_0)))), run_loop($$$$ImageOps$tr$(_target_0))));
        const _c_0 = run_loop($pool$(_rest_0, _lower_0, _h_0, _x_0, _yy_0, run_loop($select$(_commands_0, run_loop($$$$Rect$cell$(_x_0, _yy_0, _h_0)))), run_loop($$$$ImageOps$bl$(_target_0))));
        const _d_0 = run_loop($pool$(_rest_0, _lower_0, _h_0, _xx_0, _yy_0, run_loop($select$(_commands_0, run_loop($$$$Rect$cell$(_xx_0, _yy_0, _h_0)))), run_loop($$$$ImageOps$br$(_target_0))));
        return run_jump($$$$ImageOps$quad$, [_a_0, _b_0, _c_0, _d_0]);
      }
    }
  }
...
function $render$(_surface_0, _commands_0, _forks_0) {
  const _depth_0 = _surface_0["depth"];
  const _size_0 = _surface_0["size"];
  const _pixels_0 = _surface_0["pixels"];
  return {$: "Surface", ["depth"]: _depth_0, ["size"]: _size_0, ["pixels"]: run_loop($pool$(_forks_0, _depth_0, _size_0, 0, 0, _commands_0, _pixels_0))};
}

function $offload$(_surface_0, _commands_0, _forks_0) {
  const _depth_0 = _surface_0["depth"];
  const _size_0 = _surface_0["size"];
  const _pixels_0 = _surface_0["pixels"];
  return {$: "Surface", ["depth"]: _depth_0, ["size"]: _size_0, ["pixels"]: run_loop($pool$(_forks_0, _depth_0, _size_0, 0, 0, _commands_0, _pixels_0))};
...
export default {
  ...
  "Shape.bounds": run_lib($Shape$bounds$, 1),
  "Shape.rounded_case": run_lib($Shape$rounded_case$, 6),
  "Shape.rounded": run_lib($Shape$rounded$, 5),
  "Shape.ellipse_case": run_lib($Shape$ellipse_case$, 5),
  "Shape.ellipse": run_lib($Shape$ellipse$, 4),
  "Shape.closed": run_lib($Shape$closed$, 2),
  "Shape.stroked": run_lib($Shape$stroked$, 1),
  "Shape.union": run_lib($Shape$union$, 2),
  "Shape.intersect": run_lib($Shape$intersect$, 2),
  "Shape.subtract": run_lib($Shape$subtract$, 2),
  "Shape.rounded_hit": run_lib($Shape$rounded_hit$, 7),
  "Shape.test": run_lib($Shape$test$, 4),
  "Shape.hit": run_lib($Shape$hit$, 3),
  "Shape.grid": run_lib($Shape$grid$, 1),
  "Shape.samples": run_lib($Shape$samples$, 7),
  "Shape.coverage": run_lib($Shape$coverage$, 4),
  ...
  "Paint.pixel": run_lib($Paint$pixel$, 6),
  "Paint.region": run_lib($Paint$region$, 10),
  "Paint.pool": run_lib($Paint$pool$, 11),
  "Paint.fill": run_lib($Paint$fill$, 6),
  "command": run_lib($command$, 4),
  "bounds": run_lib($bounds$, 1),
  "keep": run_lib($keep$, 3),
  "select": run_lib($select$, 2),
  "one": run_lib($one$, 6),
  "serial": run_lib($serial$, 6),
  "pool": run_lib($pool$, 7),
  "render": run_lib($render$, 3),
  "offload": run_lib($offload$, 3),
};
