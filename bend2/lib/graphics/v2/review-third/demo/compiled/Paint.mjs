...
function $pixel$(_zero_0, _coverage_0, _brush_0, _x_0, _y_0, _target_0) {
  if (_zero_0) {
    return _target_0;
  } else {
    if (_target_0.$ === "Pix") {
...
function $region$(_depth_0, _span_0, _x_0, _y_0, _outside_0, _shape_0, _brush_0, _quality_0, _clip_0, _target_0) {
  if (_depth_0 === 0n) {
    if (_outside_0) {
      return _target_0;
    } else {
      const _coverage_0 = run_loop($Shape$coverage$(_shape_0, _quality_0, _x_0, _y_0));
      return run_jump($pixel$, [(_coverage_0 === 0), _coverage_0, _brush_0, _x_0, _y_0, _target_0]);
    }
  } else {
    const _rest_0 = (_depth_0 - 1n);
    if (_outside_0) {
      ...
      const _a_0 = run_loop($region$(_rest_0, _h_0, _x_0, _y_0, run_loop($Bool$not$(run_loop($$$$Rect$overlaps$(_clip_0, run_loop($$$$Rect$cell$(_x_0, _y_0, _h_0)))))), _shape_0, _brush_0, _quality_0, _clip_0, run_loop($$$$ImageOps$tl$(_target_0))));
      const _b_0 = run_loop($region$(_rest_0, _h_0, _xx_0, _y_0, run_loop($Bool$not$(run_loop($$$$Rect$overlaps$(_clip_0, run_loop($$$$Rect$cell$(_xx_0, _y_0, _h_0)))))), _shape_0, _brush_0, _quality_0, _clip_0, run_loop($$$$ImageOps$tr$(_target_0))));
      const _c_0 = run_loop($region$(_rest_0, _h_0, _x_0, _yy_0, run_loop($Bool$not$(run_loop($$$$Rect$overlaps$(_clip_0, run_loop($$$$Rect$cell$(_x_0, _yy_0, _h_0)))))), _shape_0, _brush_0, _quality_0, _clip_0, run_loop($$$$ImageOps$bl$(_target_0))));
      const _d_0 = run_loop($region$(_rest_0, _h_0, _xx_0, _yy_0, run_loop($Bool$not$(run_loop($$$$Rect$overlaps$(_clip_0, run_loop($$$$Rect$cell$(_xx_0, _yy_0, _h_0)))))), _shape_0, _brush_0, _quality_0, _clip_0, run_loop($$$$ImageOps$br$(_target_0))));
      return run_jump($$$$ImageOps$quad$, [_a_0, _b_0, _c_0, _d_0]);
    }
  }
}

function $pool$(_forks_0, _depth_0, _span_0, _x_0, _y_0, _outside_0, _shape_0, _brush_0, _quality_0, _clip_0, _target_0) {
  if (_forks_0 === 0n) {
    if (_outside_0) {
      return _target_0;
    } else {
      return run_jump($region$, [_depth_0, _span_0, _x_0, _y_0, false, _shape_0, _brush_0, _quality_0, _clip_0, _target_0]);
    }
  } else {
    ...
    if (_depth_0 === 0n) {
      if (_outside_0) {
        ...
        return run_jump($region$, [0n, _span_0, _x_0, _y_0, false, _shape_0, _brush_0, _quality_0, _clip_0, _target_0]);
      }
    } else {
      ...
      if (_outside_0) {
        ...
        const _xx_0 = ((_x_0 + _h_0) >>> 0);
        const _yy_0 = ((_y_0 + _h_0) >>> 0);
        const _a_0 = run_loop($pool$(_rest_0, _lower_0, _h_0, _x_0, _y_0, run_loop($Bool$not$(run_loop($$$$Rect$overlaps$(_clip_0, run_loop($$$$Rect$cell$(_x_0, _y_0, _h_0)))))), _shape_0, _brush_0, _quality_0, _clip_0, run_loop($$$$ImageOps$tl$(_target_0))));
        const _b_0 = run_loop($pool$(_rest_0, _lower_0, _h_0, _xx_0, _y_0, run_loop($Bool$not$(run_loop($$$$Rect$overlaps$(_clip_0, run_loop($$$$Rect$cell$(_xx_0, _y_0, _h_0)))))), _shape_0, _brush_0, _quality_0, _clip_0, run_loop($$$$ImageOps$tr$(_target_0))));
        const _c_0 = run_loop($pool$(_rest_0, _lower_0, _h_0, _x_0, _yy_0, run_loop($Bool$not$(run_loop($$$$Rect$overlaps$(_clip_0, run_loop($$$$Rect$cell$(_x_0, _yy_0, _h_0)))))), _shape_0, _brush_0, _quality_0, _clip_0, run_loop($$$$ImageOps$bl$(_target_0))));
        const _d_0 = run_loop($pool$(_rest_0, _lower_0, _h_0, _xx_0, _yy_0, run_loop($Bool$not$(run_loop($$$$Rect$overlaps$(_clip_0, run_loop($$$$Rect$cell$(_xx_0, _yy_0, _h_0)))))), _shape_0, _brush_0, _quality_0, _clip_0, run_loop($$$$ImageOps$br$(_target_0))));
        return run_jump($$$$ImageOps$quad$, [_a_0, _b_0, _c_0, _d_0]);
      }
    }
  }
...
function $fill$(_surface_0, _shape_0, _brush_0, _quality_0, _forks_0, _clip_0) {
  const _depth_0 = _surface_0["depth"];
  const _size_0 = _surface_0["size"];
  const _pixels_0 = _surface_0["pixels"];
  const _bounds_0 = run_loop($$$$Rect$intersect$(_clip_0, run_loop($Shape$bounds$(_shape_0))));
  return {$: "Surface", ["depth"]: _depth_0, ["size"]: _size_0, ["pixels"]: run_loop($pool$(_forks_0, _depth_0, _size_0, 0, 0, run_loop($Bool$not$(run_loop($$$$Rect$overlaps$(_bounds_0, run_loop($$$$Rect$screen$(_size_0)))))), _shape_0, _brush_0, _quality_0, _bounds_0, _pixels_0))};
}
...
export default {
  ...
  "pixel": run_lib($pixel$, 6),
  "region": run_lib($region$, 10),
  "pool": run_lib($pool$, 11),
  "fill": run_lib($fill$, 6),
};
