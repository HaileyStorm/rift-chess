...
try {
  ...
  await driver.openDrawer('Record'); await page.locator('#replay').click(); await page.locator('#replay-back').click(); await page.locator('#replay-exit').click(); await driver.ready(); receipt.checks.push('visible replay returns to the live packaged match');
