"""Inherited generator regressions, with the final-rules own-back-rank pawn invariant corrected.

The unmodified supplied test file is retained under reference/legacy/.
"""
...
def test_random_play_preserves_core_invariants() -> None:
    ...
    for game_index in range(12):
        ...
        for _ in range(120):
            ...
            assert all(
                piece_type(piece) != PAWN or rank_of(square) != (7 if piece > 0 else 0)
